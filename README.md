...
`[2; 67]` Гц и проходят глубину модуляции. На верхнем узле лучший пик мембраны
у MBON13 поднимается над покоем на 1,45 мВ, у MBON17 — на 1,09 мВ при пороге
7 мВ. Структурная причина видна в замороженном измерении V1c-E6.1: рёбер KC→MBON
у MBON17 617 и у MBON13 886 против 4 276 у MBON11, а глобальный скаляр этого
отношения не меняет.
...
заморозки, но ненулевой суммы недостаточно — при разреженности около 5 % решает
число совпадающих входов, а не сумма весов.
